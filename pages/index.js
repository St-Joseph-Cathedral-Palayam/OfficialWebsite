...
const Feature = ({ title, text1, text, text2, text3, text4 }) => (
  <div className={styles.church__features_container__feature}>
    ...
    <div className={styles.church__features_container_feature_text}>
      ...
      <p className={styles.text1}>{text2}</p>
      <p className={styles.text1}>{text3}</p>
      <p className={styles.text1}>{text4}</p>
    </div>
  </div>
);
  ...
  return (
    <>
      ...
      <div className={styles.stjoseph__header} id="home">
        <div
          className={styles.stjoseph__header_content}
        ...
        >
          ...
          <p>
            Welcome to the official website of the St. Joseph’s Metropolitan
            Cathedral, Trivandrum, Kerala. The St. Joseph’s Cathedral located at
            Palayam is an ancient church in India where believers from far and
      ...
      <div className={styles.home__possibility}>
        <div className={styles.home__possibility_image}>
          <img
            className={styles.home__possibility_image_tag}
        ...
        <div className={styles.home__possibility_content}>
          <h4>Our Patron Saint</h4>
          <h1 className={styles.gradient__text}>St Joseph</h1>
          <p>
            “In Joseph … heads of the household are blessed with the unsurpassed
            model of fatherly watchfulness and care.”
          </p>
          <p>
            ...
            those who made up legends about him. We know he was a carpenter, a
            working man, for the skeptical Nazarenes ask about Jesus, "Is this
            not the carpenter's son?" (Matthew 13:55). He wasn't rich for when
            he took Jesus to the Temple to be circumcised and Mary to be
            purified he offered the sacrifice of two turtledoves or a pair of
            pigeons, allowed only for those who could not afford a lamb (Luke
            2:24). Despite his humble work and means, Joseph came from a royal
            lineage. Luke and Matthew disagree some about the details of
            Joseph's genealogy but they both mark his descent from David, the
            greatest king of Israel (Matthew 1:1-16 and Luke 3:23-38). Indeed
        ...
        <div className={styles.church__timing_container}>
          <div className={styles.church__timing_contained}>
            <Feature
              ...
              text1="Sunday "
              text2="  5:45am 7.00 am 8.45 am  10.15am 3.30pm(English) 5.00pm 7.00pm"
              text3="Weekdays"
              text4="6.00am  5.30pm"
            />
          </div>
          <div className={styles.church__timing_contained}>
            <Feature
              title="St.Sebastian's Chapel, Kunnukuzhy"
              text1="Sunday "
              text="7:15 am"
              text2="Week days"
              text3="6.00 am"
            ...
            <Feature
              title="St. Peters's Church, Pattoor"
              text1="Sunday "
              text="9.00 am (English)"
            />
          </div>
          <div className={styles.church__timing_contained}>
            <Feature
            ...
            <Feature
              title="SantaMaria Oldage Home, Plamoodu"
              text1="Sunday "
              text="6.00 am"
              text2="Week days"
              text3="6.30 am"
      ...
      <div className={styles.stjoseph__brand_container} id="contact">
        <h1 className={styles.gradient__text} style={{ textAlign: "center" }}>
          {" "}
          "Contact Us"{" "}
        </h1>
        <Contact />
